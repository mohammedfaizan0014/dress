...
#'
#' @description
#'  Wage and other data protected with some disclosure control method for original the Mid-Atlantic region wage data.
#'
...
#'
#' @seealso \code{\link[ISLR]{Wage}} \code{\link[dress]{wage4}}
#'
#' @examples
#' head(wage4_protected)
"wage4_protected"
